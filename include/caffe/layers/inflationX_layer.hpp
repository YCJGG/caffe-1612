...
/**
* bottom[0]: data, bottom[1]: factor, bottom[2]: label
* top[0]: data, top[1]: (factor_diff_space,height)
*/

class InflationXLayer: public Layer<Dtype> {
 public:
  /**
   * @param param provides InflationFactorParameter inflation_factor_param,
   *     with InflationXLayer options:
  ...
  virtual inline const char* type() const { return "InflationX"; }
