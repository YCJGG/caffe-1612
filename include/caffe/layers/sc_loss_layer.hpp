#ifndef CAFFE_SC_LOSS_LAYER_HPP_
#define CAFFE_SC_LOSS_LAYER_HPP_
...
class StatisticContextualLossLayer : public LossLayer<Dtype> {
 public:
  explicit StatisticContextualLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SCLoss"; }
...
#endif  // CAFFE_SC_LOSS_LAYER_HPP_
